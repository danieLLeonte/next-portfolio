    ...
    <section className="flex justify-between">
      <div className="flex-1 flex flex-col gap-y-9">
        ...
        <h1 className="font-bold text-[4.15rem] text-textPrimary leading-[5.4rem]">
          Professional <br /> Web Developer <br /> based in USA
        </h1>
        <p className="font-medium leading-9">
          I am a professional web developer with 2+ years of experience. I have
          a passion for creating beautiful and functional websites. I am currently
          working with React, Node, and MongoDB.
        </p>
        <div className="flex gap-11 items-center">
          <button className="bg-primary text-white font-bold text-sm py-5 px-11 rounded-full">Contact Me</button>
