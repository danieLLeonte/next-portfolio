  ...
  return (
    <section className="flex justify-between flex-col laptop:flex-row">
      <div className="flex-1 flex flex-col gap-y-9 items-center">
        ...
        <h1 className="sm:font-bold font-[800] sm:text-[4.15rem] text-4xl text-textPrimary sm:leading-[5.4rem] leading-[155%] text-center">
          Professional <br />
        ...
        <p className="sm:font-medium font-semibold sm:text-base text-xs sm:leading-9 leading-7 text-center laptop:text-left">
        ...
        <div className="flex gap-11 items-center flex-col sm:flex-row">
          ...
          <Image src={lineDirection} alt="line" width={100} height={100} className="hidden sm:block" />
        </div>
      </div>
      <Image
        src={graphic}
        ...
        width={650}
        height={650}
        className="flex-1 object-contain self-center"
      />
    </section>
  );
};
